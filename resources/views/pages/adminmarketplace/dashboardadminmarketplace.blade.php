...
<main>
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
            ...
            <div class="small">
                <svg class="svg-inline--fa fa-cogs fa-w-20" aria-hidden="true" focusable="false" data-prefix="fa"
                    data-icon="cogs" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"
                    data-fa-i2svg="">
                ...
                </svg><!-- <i class="fa fa-cogs" aria-hidden="true"></i> -->
                Bengkel
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <h2 class="m-0 font-weight-bold text-primary" style="text-align: center">Selamat Datang,
                            {{Auth::user()->pegawai->nama_pegawai}}</h2>
